        ...
        <div className='md:m-auto md:max-w-6xl md:py-4'>
          <div className='md:grid md:grid-cols-3 md:gap-8'>
            <div className='text-center md:text-left text-xs md:text-base'>
              ...
              <h2 className='md:px-4 md:pt-2 hover:text-[#397EBA]'><Link to={""}>Tuyển dụng</Link></h2>
              <h2 className='md:px-4 md:pt-2 hover:text-[#397EBA]'><Link to={""}>Giới thiệu</Link></h2>
              <h2 className='md:px-4 md:pt-2 hover:text-[#397EBA]'><Link to={""}>Liên hệ</Link></h2>
              <h2 className='md:px-4 md:pt-2 hover:text-[#397EBA]'><Link to={""}>Liên hệ quảng cáo</Link></h2>
              <h2 className='md:px-4 md:pt-2 hover:text-[#397EBA]'><Link to={""}>Hướng dẫn đặt vé online</Link></h2>
            </div>
