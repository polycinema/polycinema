...
export const { useGetCouponByIdUserQuery, useAddCouponMutation, useDeleteCouponMutation, useGetAllCouponQuery, useEditCouponMutation ,useGetCouponByIDQuery} = couponApi;
